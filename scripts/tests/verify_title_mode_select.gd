...
func _init() -> void:
	...
	assert(is_equal_approx(main.title_hi_score.anchor_left, 1.0))
	assert(is_equal_approx(main.title_hi_score.anchor_top, 1.0))
	assert(is_equal_approx(main.title_hi_score.offset_right, -main.GameHudUtil.HUD_MARGIN))
	assert(is_equal_approx(main.title_hi_score.offset_bottom, -main.GameHudUtil.HUD_MARGIN))
	assert(is_equal_approx(main.title_hi_score.offset_left, -main.GameHudUtil.HUD_MARGIN - main.title_hi_score.size.x))
	assert(is_equal_approx(main.title_hi_score.offset_top, -main.GameHudUtil.HUD_MARGIN - main.title_hi_score.size.y))
